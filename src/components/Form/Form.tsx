                ...
                <div className="my-5">
                    <div>
                        ...
                        <div className="mt-2">
                            ...
                            <div className="mt-2">
                                <input type="phone" id="phone" autoComplete="phone" name="phone" className="w-full rounded-md border-0 py-1.5 text-secondary shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-0 focus:ring-inset text-sm" />
                            </div>
                        </div>
                        <div className="mt-2">
                        ...
                        <div className="flex justify-between gap-5 my-4">
                            ...
                            <button className="border-[1px] border-secondary text-secondary px-2 py-2 rounded-lg text-sm flex items-center">
