...
export function Location() {
    ...
    return (
        <Transition className="px-4 py-8 md:py-44 md:px-36">
            ...
            <h2 className="max-w-2xl mx-auto my-4 mb-8 text-3xl font-semibold text-center">Disponibles en todo Entre Ríos, somos la inmobiliaria con más propiedades desde 2015</h2>
