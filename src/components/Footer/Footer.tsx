...
export function Footer() {
    return (
        <div className="px-4 py-8 bg-black/90 md:py-40 md:px-36">
            <div className="grid gap-8 md:grid-cols-[1fr,1fr,1fr,400px] text-white">
                ...
                <div className="md:text-right">
                            <h4 className='mb-6 text-xl font-semibold'>Inmobiliaria First Space</h4>
                            <p>Avenida Siempre Viva 3389</p>
